    ...
    F.prototype.pullData = function(e) {
        ...
        if (i.startTime = (new Date).getTime(), a.url) {
            ...
            t.ajax({
                ...
                success: function(t) {
                	try{
						var countNameInfo = n.countName;
						var dataNameInfo = n.dataName;
						t.newcountName = searchData(n,t,"countName");
						t.newdataName = searchData(n,t,"dataName");
                    ...
                    n.countName = countNameInfo;
					n.dataName = dataNameInfo;
