...
public class OrderQuery {
	...
	public void queryPayOrder() {
		...
		for (PayOrder payOrder : payOrders) {
			...
			orgBuf.append("VNo=").append(CommonStatic.PAY_VERSION).append("&Sgn_Algr=")
					.append(CommonStatic.SIGNATURE_ALGORITHM).append("&Cmdty_Ordr_No=").append(payOrder.getOrderNo())
